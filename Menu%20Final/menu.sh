...
Name=$(curl -sS https://raw.githubusercontent.com/Agunxzzz/Mina-Xray-SSH/main/permission/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/Agunxzzz/Mina-Xray-SSH/main/permission/ip | grep $MYIP | awk '{print $3}')
